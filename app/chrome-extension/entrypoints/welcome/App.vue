...
const COMMANDS = {
  npmInstall: 'npm install -g mcp-chrome-beta-bridge',
  pnpmInstall: 'pnpm add -g mcp-chrome-beta-bridge',
  yarnInstall: 'yarn global add mcp-chrome-beta-bridge',
  mcpUrl: 'http://127.0.0.1:' + NATIVE_HOST.DEFAULT_PORT + '/mcp',
  doctor: 'mcp-chrome-beta-bridge doctor',
  fix: 'mcp-chrome-beta-bridge doctor --fix',
  report: 'mcp-chrome-beta-bridge report --copy',
} as const;
        ...
        <div class="max-w-3xl mx-auto space-y-6">
          <section class="welcome-card welcome-card--primary p-6">
            <h2 class="welcome-title text-xl font-medium">
              Install <code class="welcome-code">mcp-chrome-beta-bridge</code>
            </h2>
